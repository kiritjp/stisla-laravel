    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row mb-4" v-if="$parent.userCan('login-super-admin') && !getUserdata('isme')">
                ...
                <div class="form-group row mb-4" v-if="!$parent.userCan('login-super-admin')">
